...
public class Imagem extends Geometria {
    ...
    private float indiceQuadro;
    private float iTotalColunas;
    private float iTotalLinhas;
    private float larguraImagem;
    private float larguraQuadro;

    private float fCoordX1;
    private float fCoordX2;

    private float fCoordY1;
    private float fCoordY2;
    ...
    public Imagem(GL10 gl, int tamanho, Activity tela) {
        ...
        //indiceQuadro = coordenadasTexturas.length;
        iTotalColunas = 2;
        iTotalLinhas = 4;
        larguraImagem = 1024;
        larguraQuadro =

        fCoordX1 = (indiceQuadro % iTotalColunas) * (1.0f / iTotalColunas);
        fCoordY1 = (indiceQuadro / iTotalColunas) * (1.0f/ iTotalLinhas);

        fCoordX2 = fCoordX1 + 1.0f/(larguraImagem / larguraQuadro);
        fCoordY2 = fCoordY1 + 1.0f/(larguraImagem/ larguraQuadro);
